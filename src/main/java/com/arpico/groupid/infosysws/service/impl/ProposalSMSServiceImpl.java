...
@Service
@Transactional
public class ProposalSMSServiceImpl implements ProposalSMSService{
	...
	public ResponseDto getProposalSMSMessage(SMSDto smsDto) throws Exception {
		...
		if(receiptDetails != null) {
			...
			mobileList.add(customerMob);
			
			SendSMSDto sendSMSDto=new SendSMSDto();
			sendSMSDto.setMessage(replaceString);
			sendSMSDto.setMobileList(mobileList);
